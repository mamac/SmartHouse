 ...
 */
class WaterlogRepository extends EntityRepository
{

  public function getWaterlogrecords()
  {
    ...
    $query = $em->createQuery("
      ...
      a.metervalue,
      a.consumption
      FROM LljmHomeBundle:Waterlog a
