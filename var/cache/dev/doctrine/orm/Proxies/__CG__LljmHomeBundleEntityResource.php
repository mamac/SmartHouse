 ...
 */
class Resource extends \Lljm\HomeBundle\Entity\Resource implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Lljm\\HomeBundle\\Entity\\Resource' . "\0" . 'id', '' . "\0" . 'Lljm\\HomeBundle\\Entity\\Resource' . "\0" . 'resourcename'];
        }
