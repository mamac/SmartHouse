...
/* LljmHomeBundle:Visualization:elecvisual_daily.html.twig */
class __TwigTemplate_3a72c2a915d83638328d3f884697c77f4c33aa5ccde83220fc95759c4ae551ec extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("LljmHomeBundle::layout.html.twig", "LljmHomeBundle:Visualization:elecvisual_daily.html.twig", 1);
        $this->blocks = array(
...
var barChartData = [
  ...
  ";
        // line 67
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(($context["eleclogdailys"] ?? null));
        foreach ($context['_seq'] as $context["_key"] => $context["eleclogdaily"]) {
            // line 68
            echo "     {x: ";
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->getSourceContext(), $context["eleclogdaily"], "daterx", array()), "U"), "html", null, true);
            echo ", y: ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->getSourceContext(), $context["eleclogdaily"], "consumption", array()), "html", null, true);
            echo "},
  ";
        }
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['eleclogdaily'], $context['_parent'], $context['loop']);
        $context = array_intersect_key($context, $_parent) + $_parent;
        // line 70
        echo "   ]
  }
  ...
  ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["eleclogdaily"]) {
            ...
            <td>";
            // line 108
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->getSourceContext(), $context["eleclogdaily"], "daterx", array()), "Y-m-d H:i:s"), "html", null, true);
            echo "</td>
            <td>";
            // line 109
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->getSourceContext(), $context["eleclogdaily"], "consumption", array()), "html", null, true);
...
";
    ...
    {
        return "LljmHomeBundle:Visualization:elecvisual_daily.html.twig";
    }
    ...
    {
        return new Twig_Source("", "LljmHomeBundle:Visualization:elecvisual_daily.html.twig", "/home/lljm/web/src/Lljm/HomeBundle/Resources/views/Visualization/elecvisual_daily.html.twig");
    }
}
