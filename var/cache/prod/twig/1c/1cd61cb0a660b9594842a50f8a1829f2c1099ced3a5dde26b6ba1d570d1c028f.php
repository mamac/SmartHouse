...
/* LljmHomeBundle:Visualization:watervisual_weekly.html.twig */
class __TwigTemplate_13df9bc9c1482f0d93bfd496faf5f9a2e5326d2fda5d761fe4ba83032b57189a extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("LljmHomeBundle::layout.html.twig", "LljmHomeBundle:Visualization:watervisual_weekly.html.twig", 1);
        $this->blocks = array(
...
var barChartData = [
  ...
  ";
        // line 67
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(($context["waterlogweeklys"] ?? null));
        foreach ($context['_seq'] as $context["_key"] => $context["waterlogweekly"]) {
            // line 68
            echo "     {x: '";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->getSourceContext(), $context["waterlogweekly"], "yearweek", array()), "html", null, true);
            echo "', y: ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->getSourceContext(), $context["waterlogweekly"], "consumption", array()), "html", null, true);
            echo "},
  ";
        }
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['waterlogweekly'], $context['_parent'], $context['loop']);
        $context = array_intersect_key($context, $_parent) + $_parent;
        // line 70
        echo "   ]
  }
...
";
    ...
    {
        return "LljmHomeBundle:Visualization:watervisual_weekly.html.twig";
    }
    ...
    {
        return new Twig_Source("", "LljmHomeBundle:Visualization:watervisual_weekly.html.twig", "/home/lljm/web/src/Lljm/HomeBundle/Resources/views/Visualization/watervisual_weekly.html.twig");
    }
}
