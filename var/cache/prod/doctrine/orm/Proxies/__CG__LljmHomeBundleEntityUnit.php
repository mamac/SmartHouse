 ...
 */
class Unit extends \Lljm\HomeBundle\Entity\Unit implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Lljm\\HomeBundle\\Entity\\Unit' . "\0" . 'id', '' . "\0" . 'Lljm\\HomeBundle\\Entity\\Unit' . "\0" . 'unitname'];
        }
