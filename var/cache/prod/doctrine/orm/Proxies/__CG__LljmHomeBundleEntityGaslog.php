 ...
 */
class Gaslog extends \Lljm\HomeBundle\Entity\Gaslog implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Lljm\\HomeBundle\\Entity\\Gaslog' . "\0" . 'id', 'daterx', '' . "\0" . 'Lljm\\HomeBundle\\Entity\\Gaslog' . "\0" . 'meterid', 'metervalue', '' . "\0" . 'Lljm\\HomeBundle\\Entity\\Gaslog' . "\0" . 'consumption', '' . "\0" . 'Lljm\\HomeBundle\\Entity\\Gaslog' . "\0" . 'yearweek', '' . "\0" . 'Lljm\\HomeBundle\\Entity\\Gaslog' . "\0" . 'yearmonth', '' . "\0" . 'Lljm\\HomeBundle\\Entity\\Gaslog' . "\0" . 'monthmonth'];
        }

        return ['__isInitialized__', '' . "\0" . 'Lljm\\HomeBundle\\Entity\\Gaslog' . "\0" . 'id', '' . "\0" . 'Lljm\\HomeBundle\\Entity\\Gaslog' . "\0" . 'meterid', '' . "\0" . 'Lljm\\HomeBundle\\Entity\\Gaslog' . "\0" . 'consumption', '' . "\0" . 'Lljm\\HomeBundle\\Entity\\Gaslog' . "\0" . 'yearweek', '' . "\0" . 'Lljm\\HomeBundle\\Entity\\Gaslog' . "\0" . 'yearmonth', '' . "\0" . 'Lljm\\HomeBundle\\Entity\\Gaslog' . "\0" . 'monthmonth'];
    }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Gaslog $proxy) {
